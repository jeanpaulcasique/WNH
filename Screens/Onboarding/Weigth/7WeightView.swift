        ...
        .gesture(
            DragGesture()
                .onChanged { value in
                    ...
                    NotificationCenter.default.post(name: .weightPickerDragChanged, object: value.translation.width)
                }
                .onEnded { value in
                    NotificationCenter.default.post(name: .weightPickerDragEnded, object: value.translation.width)
                }
        )
    }
}
...
// Nuevo componente WeightTapePicker
struct WeightTapePicker: View {
    let items: [Double]
    ...
    var body: some View {
        GeometryReader { geometry in
            ...
            .onReceive(NotificationCenter.default.publisher(for: .weightPickerDragChanged)) { notif in
            ...
            .onReceive(NotificationCenter.default.publisher(for: .weightPickerDragEnded)) { notif in
                if let width = notif.object as? CGFloat {
                    let baseIndex = dragStartIndex ?? selectedIndex
...
extension Notification.Name {
    static let weightPickerDragChanged = Notification.Name("weightPickerDragChanged")
    static let weightPickerDragEnded = Notification.Name("weightPickerDragEnded")
}
