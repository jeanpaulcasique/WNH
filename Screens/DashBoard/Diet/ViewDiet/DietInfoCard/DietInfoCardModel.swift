...
class DietInfoCardModel: ObservableObject {
    ...
    private func setupDefaultTips() {
        let defaultTips = [
            ...
            DietInfoCard(
                ...
                title: "Descubre marcas de lujo a precios reducidos",
                content: "Disfruta de descuentos en AliExpress...",
                color: Color(red: 0.157, green: 0.118, blue: 0.239), // #281E3D
                actionURL: "https://aliexpress.com",
                priority: 11,
                brandLogo: "aliexpress",
    ...
    func dismissCard(_ card: DietInfoCard) {
